...
namespace MyGengoTranslator.Classes
{
    class EJobStatus
    {
        public const string JOB_STATUS_AVAILABLE = "available";
        public const string JOB_STATUS_PENDING = "pending";
        public const string JOB_STATUS_REVIEWABLE = "reviewable";
        public const string JOB_STATUS_REVISING = "revising";
        public const string JOB_STATUS_APPROVED = "approved";
        public const string JOB_STATUS_CANCELLED = "cancelled";
        public const string JOB_STATUS_HELD = "held";       
